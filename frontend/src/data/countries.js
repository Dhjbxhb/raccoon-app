// Country dial codes for the phone-number sign-in picker.
// { code: ISO 3166-1 alpha-2, name, dial: calling code without '+' }
...
// Best-effort default from the browser locale region (e.g. "en-PK" -> PK), else US
